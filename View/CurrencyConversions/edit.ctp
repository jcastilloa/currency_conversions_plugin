<hgroup id="main-title" class="thin">
			<h1><?php echo __('Edit Currency Conversion'); ?></h1>
...
<?php echo $this->Form->create('CurrencyConversion'); ?>
	<fieldset class="fieldset">
		<legend class="legend"><?php echo __('Edit Currency Conversion'); ?></legend>
			<?php
...
<div class="clear-both columns with-padding">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CurrencyConversion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CurrencyConversion.id'))); ?></li>
